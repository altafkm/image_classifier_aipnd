...
parser.add_argument('--path2image', action='store', default='.')
...
files = os.listdir(args.path2image)
...
image_path = '/content/flowers/test/85/image_04797.jpg'
...
with Image.open('/content/flowers/test/85/image_04797.jpg') as image:
    plt.imshow(image)
